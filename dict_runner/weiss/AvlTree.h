	    ...
	    void print(ostream & out = cout, string filler = "") const;
	    ...
	    void print(ostream & out = cout) const { 
	      // Represent an empty tree with a NULL symbol.
	      if (root == NULL) {
		out << "--|:." << endl;
	      }
	      // If there are any nodes, ask the root to print itself.
	      else {
		root->print(out);
	      }
	    }
	    ...
	    bool remove(const Comparable & x, AvlNode<Comparable> *& subroot);
