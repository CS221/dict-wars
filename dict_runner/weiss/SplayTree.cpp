        ...
        {
            nullNode = new SBinaryNode<Comparable>;
        ...
        {
            static SBinaryNode<Comparable> *newNode = NULL;

            if( newNode == NULL )
                newNode = new SBinaryNode<Comparable>;
            newNode->element = x;
        ...
        {
            SBinaryNode<Comparable> *newTree;
        ...
        const Comparable & SplayTree<Comparable>::findMin( )
        {
            ...
            SBinaryNode<Comparable> *ptr = root;
         ...
         */
        template <class Comparable>
        void SplayTree<Comparable>::rotateWithLeftChild( SBinaryNode<Comparable> * & k2 ) const
        {
            SBinaryNode<Comparable> *k1 = k2->left;
            k2->left = k1->right;
            k1->right = k2;
            k2 = k1;
        }
         ...
         */
        template <class Comparable>
        void SplayTree<Comparable>::rotateWithRightChild( SBinaryNode<Comparable> * & k1 ) const
        {
            SBinaryNode<Comparable> *k2 = k1->right;
            k1->right = k2->left;
            k2->left = k1;
            k1 = k2;
        }
         ...
         */
        template <class Comparable>
        void SplayTree<Comparable>::printTree( SBinaryNode<Comparable> *t ) const
        {
            if( t != t->left )
            {
                printTree( t->left );
         ...
         */
        template <class Comparable>
        void SplayTree<Comparable>::reclaimMemory( SBinaryNode<Comparable> * t ) const
        {
            if( t != t->left )
            {
         ...
         */
        template <class Comparable>
        SBinaryNode<Comparable> *
        SplayTree<Comparable>::clone( SBinaryNode<Comparable> * t ) const
        {
            if( t == t->left )  // Cannot test against nullNode!!!
                return nullNode;
            else
                return new SBinaryNode<Comparable>( t->element, clone( t->left ), clone( t->right ) );
        }
